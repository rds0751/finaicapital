...
def add(request):
    return render(request, 'voxa/add.html', {})
...
def level(request):
    return render(request, 'voxa/level.html', {})
...
def profit(request):
    return render(request, 'voxa/profit.html', {})
    
def reward(request):
    return render(request, 'voxa/reward.html', {})
    
def start(request):
    return render(request, 'voxa/start.html', {})
    
def withdrawal(request):
    return render(request, 'voxa/withdrawal.html', {})
