...
from ..clients.metaApi.tokenManagement_client import TokenManagementClient
from ..metaApi.tokenManagementApi import TokenManagementApi
...
class MetaApi:
    ...
    def __init__(self, token: str, opts: MetaApiOpts = None):
        ...
        self._tokenManagementApi = TokenManagementApi(token_management_client)
    ...
    def token_management_api(self) -> TokenManagementApi:
        ...
        """
        return self._tokenManagementApi
